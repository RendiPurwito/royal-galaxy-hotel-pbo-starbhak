...
<td>
    ...
    <a href="/admin/public-facility/{{ $row->id }}" class="btn btn-danger btn-sm">Delete</a>
</td>
</tr>
@endforeach
</tbody>
...
<div class="card">
    <div class="card-header">
        ...
        <a href="/admin/public-facility/create" class="btn btn-primary btn-sm float-right ml-3">Create</a>
    </div>
    <div class="card-body">
